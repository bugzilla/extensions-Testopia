...
sub page_before_template {
    ...
    elsif ($page eq 'tr_builds.html') {
        require Bugzilla::Extension::Testopia::Builds;
        Bugzilla::Extension::Testopia::Builds::report($vars);
    }
    ...
    elsif ($page eq 'tr_list_caseruns.html') {
        require Bugzilla::Extension::Testopia::List::CaseRuns;
        Bugzilla::Extension::Testopia::List::CaseRuns::report($vars);
    }
    ...
    elsif ($page eq 'tr_list_runs.html') {
        require Bugzilla::Extension::Testopia::List::Runs;
        Bugzilla::Extension::Testopia::List::Runs::report($vars);
    }
    ...
    elsif ($page eq 'tr_process_case.html') {
        require Bugzilla::Extension::Testopia::Process::Case;
        Bugzilla::Extension::Testopia::Process::Case::report($vars);
    }
    elsif ($page eq 'tr_process_plan.html') {
