...
sub test_check_category {
    ...
    my $obj = Bugzilla::Extension::Testopia::Category->new($rep->{'category_id'});
...
sub test_check_product {
    ...
    my $obj = Bugzilla::Extension::Testopia::Product->new($rep->{'id'});
...
sub test_get_builds {
    ...
    my $obj = Bugzilla::Extension::Testopia::Product->new($rep->{'product_id'});
...
sub test_get_cases {
    ...
    my $plan = Bugzilla::Extension::Testopia::TestPlan->new($rep->{'plan_id'});
    my $obj = $plan->product;
...
sub test_get_runs {
    ...
    my $run = Bugzilla::Extension::Testopia::TestRun->new($rep->{'run_id'});
