...
package Bugzilla::Extension::Testopia::Product;
...
sub environments {
    ...
    my @objs;
    foreach my $id (@{$ref}){
        push @objs, Bugzilla::Extension::Testopia::Environment->new($id);
    }
...
sub builds {
    ...
    my @objs;
    foreach my $id (@{$ref}){
        push @objs, Bugzilla::Extension::Testopia::Build->new($id);
    }
...
sub categories {
    ...
    foreach my $id (@{$ref}){
        push @objs, Bugzilla::Extension::Testopia::Category->new($id);
    }
...
sub plans {
    ...
    foreach my $id (@{$ref}){
        push @objs, Bugzilla::Extension::Testopia::TestPlan->new($id);
    }
    $self->{'plans'} = \@objs;
    return $self->{'plans'};
}
...
sub environment_categories {
    ...
    foreach my $id (@{$ref}){
        push @objs, Bugzilla::Extension::Testopia::Environment::Category->new($id);
    }
...
sub tags {
    ...
    require Bugzilla::Extension::Testopia::TestTag;
    ...
    my @product_tags;
    foreach my $id (@$ref){
        push @product_tags, Bugzilla::Extension::Testopia::TestTag->new($id);
    }
...
Bugzilla::Extension::Testopia::Product
...
=head2 Creating
 ...
 $build = Bugzilla::Extension::Testopia::Product->new($product_id);
 $build = Bugzilla::Extension::Testopia::Product->new({name => $name});
