...
Bugzilla::Extension::Testopia::Table - Produces display tables for Testopia lists
...
=head1 SYNOPSIS
 ...
 $table = Bugzilla::Extension::Testopia::Table->new($type, $url, $cgi, $list, $query);

=cut

package Bugzilla::Extension::Testopia::Table;
...
sub init {
    ...
    if ($query){
        ...
        foreach my $id (@$list){
            my $o;
            if ($type eq 'case'){
                $o = Bugzilla::Extension::Testopia::TestCase->new($id);
            }
            elsif ($type eq 'plan'){
                $o = Bugzilla::Extension::Testopia::TestPlan->new($id);
            }
            elsif ($type eq 'run'){
                $o = Bugzilla::Extension::Testopia::TestRun->new($id);
            }
            elsif ($type eq 'case_run'){
                $o = Bugzilla::Extension::Testopia::TestCaseRun->new($id);
            }
            elsif ($type eq 'environment'){
                $o = Bugzilla::Extension::Testopia::Environment->new($id);
            }
            push (@ids, $id);
            push (@list, $o);
        }
...
#                my $o = Bugzilla::Extension::Testopia::TestCase->new($id);
#                push @list, $o;
#                $o->category;
#                $o->status;
#                $o->priority;
...
#                my $o = Bugzilla::Extension::Testopia::TestPlan->new($id);
#                push @list, $o;
#                $o->test_case_count;
#                $o->test_run_count;
#            }
...
Bugzilla::Extension::Testopia::Search
