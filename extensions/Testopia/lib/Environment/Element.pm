...
Bugzilla::Extension::Testopia::Environment::Element - A test environment element
...
=head1 SYNOPSIS
 ...
 $elem = Bugzilla::Extension::Testopia::Environment::Element->new($elem_id);
 $elem = Bugzilla::Extension::Testopia::Environment::Element->new(\%elem_hash);

=cut

package Bugzilla::Extension::Testopia::Environment::Element;
...
sub get_child_elements {
    ...
    foreach my $val (@$ref) {
        my $child = Bugzilla::Extension::Testopia::Environment::Element->new($val);
...
sub get_properties {
    ...
    foreach my $val (@$ref) {
        my $property = Bugzilla::Extension::Testopia::Environment::Property->new($val);
