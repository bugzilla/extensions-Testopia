...
Bugzilla::Extension::Testopia::Environment::Property - A test environment element property
...
=head1 SYNOPSIS
 ...
 $prop = Bugzilla::Extension::Testopia::Environment::Property->new(\%prop_hash);

=cut

package Bugzilla::Extension::Testopia::Environment::Property;
...
sub value_to_json {
    ...
    my $env = Bugzilla::Extension::Testopia::Environment->new($env_id) if $env_id;
...
sub canview {
    my $self = shift;
    my $element =
      Bugzilla::Extension::Testopia::Environment::Element->new( $self->element_id );
