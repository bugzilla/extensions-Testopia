...
package Bugzilla::Extension::Testopia::Build;
...
sub check_build {
    ...
    if ($throw){
        ...
        return Bugzilla::Extension::Testopia::Build->new($is);
    }
    return $is;
}
...
Bugzilla::Extension::Testopia::Build
...
=head2 Creating
 ...
 $build = Bugzilla::Extension::Testopia::Build->new($build_id);
 $build = Bugzilla::Extension::Testopia::Build->new({name => $name});

 $new_build = Bugzilla::Extension::Testopia::Build->create({name => $name, 
                                                 description => $desc
                                                 ... });
...
=item C<new($param)>
 ...
 Returns:     A blessed Bugzilla::Extension::Testopia::Build object
...
=item C<product()>
 ...
 Returns a Bugzilla::Extension::Testopia::Product object of the product this build is of.
