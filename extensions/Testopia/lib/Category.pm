...
package Bugzilla::Extension::Testopia::Category;
...
our @EXPORT = qw(check_case_category);
...
Bugzilla::Extension::Testopia::Category - An object representing a test case category
...
=head2 Creating
 ...
 $category = Bugzilla::Extension::Testopia::Category->new({name => $name});
  
 $new_category = Bugzilla::Extension::Testopia::Category->create({name => $name, 
                                                       description => $desc});
...
=item C<new($param)>
 ...
 Returns:     A blessed Bugzilla::Extension::Testopia::Category object
